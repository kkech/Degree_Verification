 ...
 */
contract VerifTokenERC20 is IERC20 {
    using SafeMath for uint256;

    address payable public owner;

    string public name = "VerifToken";
    string public symbol = "VT";
    string public standard = "VerifToken v1.0";
    ...
    function burn(address account, uint256 value) public onlyOwner returns (bool success){
        _burn(account, value);
       return true;
    }
